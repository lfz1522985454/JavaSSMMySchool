...
public class Topic implements Serializable {
	...
	public Topic(Integer topicId, Integer skillId, Integer opicTypeId, String topicName, String topicImg,
			...
			Integer isEnabled, Integer isStamp, Integer stampBy, Integer count) {
		super();
		this.topicId = topicId;
		this.skillId = skillId;
		this.opicTypeId = opicTypeId;
