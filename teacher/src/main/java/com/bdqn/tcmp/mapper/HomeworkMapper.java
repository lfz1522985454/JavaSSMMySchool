...
public interface HomeworkMapper{
	 ...
	 * @return 受影响行数
	 */
	int updateHomeworkEnabledByID(@Param("id")int id, @Param("value")int value);
	/**
	 * 删除指定主键的数据
	 * @param id
	 *            表的主键
	 ...
	 * @return Homework集合对象
	 */
	List<Homework> selectHomeworkByClassID(@Param("classId")Integer classId);
	 ...
	 * @return Homework集合对象
	 */
	List<Homework> selectHomeworkByClassIdAndStage(@Param("classId")Integer classId,@Param("stage")Integer stage);
