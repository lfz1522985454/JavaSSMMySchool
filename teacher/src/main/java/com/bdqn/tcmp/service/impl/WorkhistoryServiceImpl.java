...
public class WorkhistoryServiceImpl implements WorkhistoryService{
	...
	public List<Workhistory> selectWorkhistoryByStudentId(WorkhistoryDTO dto) {
		return workhistoryMapper.selectWorkhistoryByStudentId(dto);
	}

	public Workhistory selectWorkhistoryByStudenrIdReturnOne(Integer studentId) {
		return workhistoryMapper.selectWorkhistoryByStudenrIdReturnOne(studentId);
	}
